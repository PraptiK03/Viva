...
| The **Files** folder | This contains files that are stored in Viva Engage and that are created or modified during the specified time period.<br><br>Files are named with their account ID and are in native format. For example, a PowerPoint presentation might be listed as 127815379.pptx. |
